...
setup(name='pyrnatools',
      ...
      scripts=['scripts/pyrna_align.py', 'scripts/pyrna_denovo.py', 'scripts/pyrna_diff.py', 'scripts/pyrna_count.py','scripts/pyrna_pair_tool.py','scripts/pyrna_ucsc.py', 'scripts/pyrna_download.py'],
